...
{
	{
		mytools::sheet::MTRandomOptions::create, 
		mytools::sheet::MTRandomOptions::getImplementationName_Static, 
		mytools::sheet::MTRandomOptions::getSupportedServiceNames_Static, 
